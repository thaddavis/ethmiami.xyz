    ...
    <div className="bg-white">
      <div className="w-4/5 py-10 mx-auto">
        <h4 className="text-[#e32970] text-3xl font-bold uppercase">
          {collection.length > 0 ? 'Activity' : 'No Transactions Yet'}
        </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-4 lg:gap-2 py-2.5">
          {collection.map((tx) => (
            <div
              key={tx.id}
              className="flex justify-between items-center border border-pink-500 text-[#e32970] w-full shadow-lg shadow-[#e32970] rounded-md overflow-hidden bg-white my-2 p-3"
            >
